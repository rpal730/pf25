...
class BrutalismContainer extends StatelessWidget {
  ...
  Border _buildBorder() {
    ...
    // bold edges
    final top = topBorderBold ? const BorderSide(width: 6, color: Colors.black) : baseSide;
    final bottom = bottomBorderBold ? const BorderSide(width: 6, color: Colors.black) : baseSide;
  ...
  Widget build(BuildContext context) {
    final Color bg = color ?? AppColors.primary; // MaterialColor will downgrade to default shade
    return Container(
      margin: margin,
      padding: padding,
