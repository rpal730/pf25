...
class AppColors {
  ...
  static Color get random {
    final colors = [primary, secondary, accentPeach, accentYellow, background];
    return colors[Random().nextInt(colors.length)];
  }

  // Primary: Lavender
  static const MaterialColor primary = MaterialColor(0xffd3b5f3, <int, Color>{
    50: Color(0xfff3ecfd),
  ...
  // Secondary: Mint
  static const MaterialColor secondary = MaterialColor(0xffb6f0d2, <int, Color>{
    50: Color(0xffecfbf5),
  ...
  static const MaterialColor text = MaterialColor(0xff282828, <int, Color>{
    50: Color(0xfff2f2f2),
  ...
  static const MaterialColor error = MaterialColor(0xfff24c4c, <int, Color>{
    50: Color(0xffffe6e6),
